...
export default function NotFound() {
  return (
    <>
      <Helmet>
        <title>404 - Page Not Found | SnapMails Temporary Email Service</title>
        <meta name="description" content="The page you're looking for cannot be found. Return to SnapMails' homepage to create your free temporary email address." />
