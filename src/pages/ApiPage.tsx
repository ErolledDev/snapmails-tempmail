            ...
            <section>
              ...
              <div className="flex items-center space-x-4 mt-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">No API key required for basic usage.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="border rounded-lg p-4">
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Get Email Address</h3>
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Check Emails</h3>
                  <pre className="bg-gray-50 p-4 rounded-md overflow-x-auto">
                    GET /ajax.php?f=check_email&sid_token={token}
                  </pre>
                  <p className="text-gray-600 mt-2">
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Set Custom Email</h3>
                  <pre className="bg-gray-50 p-4 rounded-md overflow-x-auto">
                    GET /ajax.php?f=set_email_user&email_user={user}&sid_token={token}
                  </pre>
                  <p className="text-gray-600 mt-2">
                    Sets a custom email address prefix.
                  </p>
                </div>
              </div>
            </section>
